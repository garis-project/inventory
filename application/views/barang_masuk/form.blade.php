...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="tgl_barang_masuk" value="{{ date('m/d/Y', strtotime($r->tgl_barang_masuk ?? date('m/d/Y'))) ?? '' }}" class="datepicker form-control" readonly>
        </div>
        <div class="form-group ">
            ...
            <select name="id_supplier" id="id_supplier" class="form-control" required>
                ...
                @php
                $id_supp = ($r->id_supplier ?? '');
                @endphp
                <option {{ ($itm->id_supplier == $id_supp) ? 'selected' : '' }} value="{{ $itm->id_supplier }}">{{ $itm->nama_supplier }}</option>
                @endforeach
            </select>
            </select>
        </div>
