<div class="main-sidebar" style="background-color: #CBFFFF	;">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <img width="100" src="<?= base_url('') ?>" alt="">
            <a href="{{ base_url('home') }}">PERSEDIAAN BARANG</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class=""><a class="nav-link" href="<?= base_url('data_admin') ?>">Data Admin</a></li>
                    <li class=""><a class="nav-link" href="<?= base_url('supplier') ?>">Data Suplier</a></li>
