...
(4, 'admin', '$2y$10$dJA6PagVj5qyYXKlkhHGqellGTHMcutK64XPoTlH7PsY7BeKHGxre', 'admin', 'admin'),
(7, 'fauzi', '$2y$10$8nXFmiWEUjnkfxMMAEZkNuVzcVuazxHQqjob1RPhO25SeiC3RtBAa', 'magista', 'admin');
...
(9, 'BR.001', 'Bondex', '001', 'pcs', 10000, 29),
(10, 'BR.002', 'Spandek', '001', 'pcs', 60000, 0);
...
CREATE TABLE `barang_keluar` (
  ...
  `tgl_barang_keluar` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(46, 'KWK001', 1, '2020-05-16 00:00:00', NULL, 'Belum Diverifikasi'),
(50, 'KWK002', 3, '2022-08-15 00:00:00', NULL, 'Belum Diverifikasi'),
(54, 'KWK003', 1, '2022-08-16 00:00:00', NULL, 'Belum Diverifikasi');
...
CREATE TABLE `barang_masuk` (
  ...
  `tgl_barang_masuk` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
(107, 'KWM001', 2, '2022-08-16 21:02:32'),
(108, 'KWM002', 2, '2022-08-16 21:03:16');
...
(129, 9, 10000, 20, 0, 107),
(130, 9, 10000, 30, 29, 108);
...
(79, 20, 9, 129, 0, 109, 54),
(80, 30, 9, 130, 29, 109, 54);
...
--
ALTER TABLE `barang_keluar`
  MODIFY `id_barang_keluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `barang_keluar_rinci`
--
ALTER TABLE `barang_keluar_rinci`
  MODIFY `id_barang_keluar_rinci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT for table `barang_masuk`
--
ALTER TABLE `barang_masuk`
  MODIFY `id_barang_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT for table `barang_masuk_rinci`
--
ALTER TABLE `barang_masuk_rinci`
  MODIFY `id_barang_masuk_rinci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `kartu_stok`
  MODIFY `id_kartu_stok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `tmp_barang`
  MODIFY `id_tmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
